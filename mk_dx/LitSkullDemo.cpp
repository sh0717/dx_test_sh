...
: D3DApp(hInstance), mShapesVB(0), mShapesIB(0), mSkullVB(0), mSkullIB(0), mSkullIndexCount(0), mLightCount(1),
  mEyePosW(0.0f, 0.0f, 0.0f), mTheta(1.5f*MathHelper::Pi), mPhi(0.1f*MathHelper::Pi), mRadius(15.0f), mDiffuseMapSRV(nullptr)
{
...
bool LitSkullApp::Init()
{
	...
	HR(D3DX11CreateShaderResourceViewFromFile(md3dDevice,
		L"../texture/WoodCrate01.dds", 0, 0, &mDiffuseMapSRV, 0));
...
void LitSkullApp::ProcessInput(HWND hwnd, WPARAM wparam) {
	switch (wparam) {
