  ...
  mEyePosW(0.0f, 0.0f, 0.0f), mLandIndexCount(0), mTheta(1.3f*MathHelper::Pi), mPhi(0.4f*MathHelper::Pi), mRadius(80.0f)
{
	...
	XMStoreFloat4x4(&mWavesWorld, XMMatrixScaling(1.0,1.0,1.0));
	XMStoreFloat4x4(&mBoxWorld, XMMatrixScaling(1.0, 1.0, 1.0));
	...
	mWavesMat.Diffuse  = XMFLOAT4(1.0f, 1.0f, 1.0f, 0.3f);
